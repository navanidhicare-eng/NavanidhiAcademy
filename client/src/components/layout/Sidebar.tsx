...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Fee Structures', href: '/admin/fees', icon: DollarSign },
      { title: 'Expenses Management', href: '/admin/expenses', icon: FileText },
      { title: 'Exam Management', href: '/admin/exam-management', icon: Award },
      { title: 'Academic Dashboard', href: '/admin/academic-dashboard', icon: BarChart3 },
      { title: 'Attendance Management', href: '/admin/attendance', icon: Calendar },
      { title: 'Course Purchases', href: '/admin/course-purchases', icon: ShoppingCart },
      { title: 'Topics Management', href: '/admin/topics-management', icon: BookOpen },
      { title: 'Dropout Requests', href: '/admin/dropout-requests', icon: X },
