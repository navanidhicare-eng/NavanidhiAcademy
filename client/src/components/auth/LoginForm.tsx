  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(https://iili.io/FmewOrJ.jpg)',
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-3/5 flex-col justify-center px-12 text-white">
          ...
          <div className="absolute top-8 left-8">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 bg-white/90 backdrop-blur-md rounded-xl flex items-center justify-center p-3 border border-white/30 shadow-xl">
        ...
        <div className="w-full lg:w-2/5 flex items-center justify-center p-8">
          <div className="w-full max-w-md mx-auto bg-black/80 lg:bg-white/15 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-10 space-y-6">
          {/* Mobile Logo (visible on small screens) */}
          <div className="lg:hidden text-center">
            <div className="flex justify-center items-center space-x-4 mb-6">
              <div className="w-20 h-20 bg-white/90 backdrop-blur-md rounded-xl flex items-center justify-center p-3 shadow-lg border border-white/30">
                <img src="/navanidhi-logo.png" alt="Navanidhi Academy" className="w-full h-full object-contain" />
              </div>
          ...
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center mb-4">
              <div className="w-24 h-24 bg-white/90 backdrop-blur-md rounded-xl flex items-center justify-center p-4 shadow-lg border border-white/30">
                <img src="/navanidhi-logo.png" alt="Navanidhi Academy" className="w-full h-full object-contain" />
              </div>
            </div>
